...
class ToWilliamsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imgv_background01_on_the_way.setImageResource(R.drawable.city_disaster03)
        ...
        tv_next.setOnClickListener {
            if(flagNext==0) {
                ...
                startActivity(
                    Intent(this, WillamsPlaceActivity::class.java)
                )
            }
